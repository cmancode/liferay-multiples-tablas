...
public interface ProductoLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.training.service.app.service.impl.ProductoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the producto local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ProductoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Producto deleteProducto(long productoId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Producto fetchProducto(long productoId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Producto getProducto(long productoId) throws PortalException;
