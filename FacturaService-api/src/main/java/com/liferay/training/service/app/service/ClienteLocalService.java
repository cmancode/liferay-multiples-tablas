...
public interface ClienteLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.training.service.app.service.impl.ClienteLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the cliente local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ClienteLocalServiceUtil} if injection and service tracking are not available.
	 */
