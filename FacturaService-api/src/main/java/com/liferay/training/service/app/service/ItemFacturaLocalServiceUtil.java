...
/**
 * Provides the local service utility for ItemFactura. This utility wraps
 * <code>com.liferay.training.service.app.service.impl.ItemFacturaLocalServiceImpl</code> and
 ...
 * @generated
 */
public class ItemFacturaLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.training.service.app.service.impl.ItemFacturaLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ItemFactura addItemFactura(ItemFactura itemFactura) {
		return getService().addItemFactura(itemFactura);
	}

	public static List<ItemFactura> buscarItems() {
		return getService().buscarItems();
	}

	public static ItemFactura crearItemFactura(
		long facturaId, long productoId, long cantidadProd) {

		return getService().crearItemFactura(
	 ...
	 */
	public static ItemFactura createItemFactura(long itemFacturaId) {
		return getService().createItemFactura(itemFacturaId);
	}
	 ...
	 */
	public static ItemFactura deleteItemFactura(ItemFactura itemFactura) {
		return getService().deleteItemFactura(itemFactura);
	}
	 ...
	 */
	public static ItemFactura deleteItemFactura(long itemFacturaId)
		throws PortalException {

		return getService().deleteItemFactura(itemFacturaId);
	}
	...
	public static ItemFactura fetchItemFactura(long itemFacturaId) {
		return getService().fetchItemFactura(itemFacturaId);
	}
	 ...
	 * @throws PortalException if a item factura with the primary key could not be found
	 */
	public static ItemFactura getItemFactura(long itemFacturaId)
		throws PortalException {

		return getService().getItemFactura(itemFacturaId);
	}
	 ...
	 */
	public static List<ItemFactura> getItemFacturas(int start, int end) {
		return getService().getItemFacturas(start, end);
	}
	 ...
	 */
	public static int getItemFacturasCount() {
		return getService().getItemFacturasCount();
	}
	 ...
	 */
	public static ItemFactura updateItemFactura(ItemFactura itemFactura) {
		return getService().updateItemFactura(itemFactura);
	}

	public static ItemFacturaLocalService getService() {
		return _service;
	}

	private static volatile ItemFacturaLocalService _service;
