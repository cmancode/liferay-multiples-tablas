...
import com.liferay.training.service.app.service.ClienteLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.training.service.app.service.impl.ClienteLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.training.service.app.service.impl.ClienteLocalServiceImpl
 * @generated
 */
public abstract class ClienteLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, ClienteLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ClienteLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ClienteLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return clientePersistence.dslQuery(dslQuery);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return clientePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	@Override
	public BasePersistence<Cliente> getBasePersistence() {
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(clienteLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ClienteLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, clienteLocalService);
		}
